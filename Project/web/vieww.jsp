						...
						<thead>
							<tr class="table100-head">
								...
								<th class="column2">Recipe Name</th>
                                                                ...
                                                                <th class="column4">UserID</th>
								<th class="column5">Neutricians</th>
								<th class="column6">Discription</th>
							</tr>
						</thead>
...
//                                                                    pst.setString(1, uid);
                                                                    ResultSet rs = pst.executeQuery("select * from recipe");
                                                                    while(rs.next())
                                                                    {
								...
								<tr>
									...
									<td class="column4"><%=rs.getInt("UID")%></td>
									<td class="column5"><%=rs.getString("Neutricians")%></td>
									<td class="column6"><%=rs.getString("discription")%></td>
								</tr>
                                                                <% } 
                                                                    rs.close();
                                                                    pst.close();
